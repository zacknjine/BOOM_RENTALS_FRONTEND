          ...
          <div className= "w-full md:w-1/2">
            <div className= "bg-white rounded-lg shadow-lg p-6">
              ...
              <p className= "text-gray-600">
                ...
                With features like online payment reminders and automatic record-keeping, you can focus on growing your businesses 
          ...
          <div className= "w-full md:w-1/2">
            <div className= "bg-white rounded-lg shadow-lg p-6">
              ...
              <p className= "text-gray-600">
                ...
                Tenants can easily submit service requests and receive timely updates,fostering a positive relationship between landlords and tenants.
                This improved communication helps ensure that issues are resolved quickly and efficiently.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full md:w-1/2">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-600">
                ...
                This capability enables property managers to make informed decisions quickly, ensuring that your operations remain efficient and responsive to market changes.
              </p>
            </div>
          </div>
        </div>

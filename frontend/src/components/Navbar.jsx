  ...
  return (
    ...
    <nav className= "bg-[black] p-3 flex items-center">
      <div className= "flex items-center ml-20 space-x-2">
        ...
        <h1 className= "text-white text-xl font-sans font-bold ">Boom Rental Harmony</h1>
      </div>
      <div className="ml-auto flex justify-center space-x-4">
        
        <ul className="flex space-x-12">
          <li><a href="#home" className= "text-white  text-l font-sans font-semibold">Email Us:info@boomrental.com</a></li>
